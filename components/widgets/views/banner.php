...
<div id="main-banners-carousel" class="carousel slide main_banners" data-ride="carousel">
    ...
    <?php if (count($banners) > 1) { ?>
    <!-- Controls -->
    <a class="left carousel-control hidden-xs" href="#main-banners-carousel" role="button" data-slide="prev"></a>
    <a class="right carousel-control hidden-xs" href="#main-banners-carousel" role="button" data-slide="next"></a>
    <?php } ?>
</div>
