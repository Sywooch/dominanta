...
if (!$model) {
    ...
    $this->title = Yii::t('app', 'Edit').' «'.Html::encode($model->category_name).'»';
    ...
    <div class="col-md-8 col-xs-12">
        ...
        <?php if (file_exists($current_photo)) { ?>
            <span class="img-thumbnail" id="thumb_photo">
                <?= Html::img(str_replace(Yii::getAlias('@webroot'), '', $model->getPreview($current_photo, 410, 230))) ?>
        ...
        <?= FileUpload::widget([
            ...
            'attribute' => 'photo',
            'url' => ['/manage/market/categories/upload', 'id' => $model->id],
            'clientOptions' => [
                'accept' => 'image/jpeg'
            ],
            'clientEvents' => [
        ...
        <div class="form-group text-center">
            <?= Html::a((new Icon('remove')).' '.Yii::t('app', 'Cancel'), ['/manage/market/categories', 'pid' => $model->pid], ['class' => 'btn btn-round btn-default cancel-button']) ?>
